...
let handler = async (m, { conn, text, usedPrefix }) => {
    ...
    let sewa = `*Yuki Adistyラ Aktif Kak*
...
`
    ...
    return conn.sendButton(m.chat, hiasan, sewa, await (await fetch(`https://telegra.ph/file/6ab4daac226292a112540.jpg`)).buffer(), [["MENU", usedPrefix + "menu"], ["DONASI", usedPrefix + "donasi"]], m, {
        contextInfo: {
            externalAdReply: {
                mediaUrl: '',
                        mediaType: 2,
