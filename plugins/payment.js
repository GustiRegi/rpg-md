...
type: 'audioMessage', 
ptt: true, contextInfo:{ externalAdReply: { title: `*✧───────···────────✧*`, body: `Yuki Adistyラ`, sourceUrl: 'https://github.com/login', thumbnail: await (await fetch('https://i.ibb.co/jfZVKmC/babi2.jpg')).buffer(),}} 
     }) 
}
